        ...
        <aside className="hidden lg:flex flex-col h-screen w-64 border-r border-app-border bg-app-sidebar">
            ...
            <nav className="flex-1 p-4 space-y-4">
                {menuItems.map((menu) => {
                    ...
                    return(
                        ...
                        href={menu.href}
                        key={menu.title}
                        className={cn("flex item-center gap-3 px-3 py-2 text-sm rounded-md font-medium transition-colors durantion-300",
            ...
            <div className="border-t border-app-border p-4">
                <form action={logoutAction}>
                    ...
                    type="submit"
                    variant="ghost"
                    className="w-full justify-start gap-3 text-white hover:text-white
